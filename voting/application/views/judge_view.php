                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Judges</b>
                                </div>
                                <div class="panel-body table-responsive">
                                    <button class="btn btn-primary" id="btn_new" style="float: left; text-transform: capitalize;font-family: Tahoma, Georgia, Serif;margin-bottom: 0px !important;" data-toggle="modal" data-target="" data-placement="left" title="Register Judge" ><i class="fa fa-plus"></i> Register New Judge</button>
                                    <table id="tbl_judges" class="" cellspacing="0" width="100%">
                                        <thead class="">
                                        <tr>
                                            <th></th>
                                            <th>Code</th>
...
<div id="modal_register_judge" class="modal fade" tabindex="-1" role="dialog"><!--modal-->
<div class="modal-dialog" style="width: 40%;">
<div class="modal-content">
<div class="modal-header" style="background-color:#2ecc71;">
    <button type="button" class="close"   data-dismiss="modal" aria-hidden="true">X</button>
    <b><span id="modal_mode"> </span>Judge / Panel Info</b>
</div>
            ...
            <div class="col-lg-8">
                ...
                <div class="form-group" style="margin-bottom:0px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="judge_fname" id="txt_judge_fname" class="form-control" value="" data-error-msg="Firstname is required!" required>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom:0px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="judge_mname" id="txt_judge_mname" class="form-control" value="">
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom:0px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="judge_lname" id="txt_judge_lname" class="form-control" value="">
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom:0px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="judge_title" id="txt_judge_title" class="form-control" value="">
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom:0px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="judge_contact" id="txt_judge_contact" class="form-control" value="">
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom:0px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="judge_email" id="txt_judge_email" class="form-control" value="">
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom:0px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="judge_occupation" id="txt_judge_occupation" class="form-control" value="">
                    </div>
                </div>

                <div class="form-group" style="margin-bottom:0px;">
                    <label class="">Address * :</label>
                    <textarea name="judge_address" id="txt_judge_address" class="form-control" data-error-msg="Address is required!" required></textarea>
                </div>
...
$(document).ready(function(){
    ...
    var initializeControls=function() {
        dt=$('#tbl_judges').DataTable({
            "dom": '<"toolbar">frtip',
            "bLengthChange":false,
            "pageLength":15,
            "ajax" : "Judges/transaction/list",
            "columns": [
                {
                    "targets": [0],
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_judges tbody').on( 'click', 'tr td.details-control', function () {
            ...
            if ( row.child.isShown() ) {
                ...
                $.ajax({
                    "dataType":"html",
                    "type":"POST",
                    "url":"Judges/transaction/product-history?id="+ d.contestant_id,
                    "beforeSend" : function(){
        ...
        $('#btn_new').click(function(){
            _txnMode="new";
            $('#modal_register_judge').modal('show');
            clearFields($('#frm_judges'));
        });
        ...
        $('#tbl_judges tbody').on('click','button[name="edit_info"]',function(){
            _txnMode="edit";
        ...
        $('#tbl_judges tbody').on('click','button[name="remove_info"]',function(){
        ...
        $('#btn_save').click(function(){
            if(validateRequiredFields($('#frm_judges'))){
                if(_txnMode=="new"){
                    registerContestant().done(function(response){
                        ...
                        $('#modal_register_judge').modal('toggle');
    ...
    var registerContestant=function(){
        var _data=$('#frm_judges').serializeArray();
        _data.push({name : "photo_path" ,value : $('img[name="img_user"]').attr('src')});
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Judges/transaction/create",
            "data":_data,
